...
{
  init_symbol(&symbols[0u], "b__h170", SYM_DEF, &DEF_b__h170, 32u);
...
void MOD_files::RL_dump()
{
  ...
  DEF_b__h170 = INST_cnt.METH_read();
  DEF_signed_cnt___d8 = DEF_b__h170;
  DEF_fh___d7 = INST_fh.METH_read();
  DEF_cnt_PLUS_1___d9 = DEF_b__h170 + 1u;
  if (!(PORT_RST_N == (tUInt8)0u))
...
unsigned int MOD_files::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "b__h170", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_files::vcd_defs(tVCDDumpType dt, MOD_files &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_WILL_FIRE_RL_open = DEF_WILL_FIRE_RL_open;
      ...
      ++num;
      if ((backing.DEF_b__h170) != DEF_b__h170)
      {
	vcd_write_val(sim_hdl, num, DEF_b__h170, 32u);
	backing.DEF_b__h170 = DEF_b__h170;
      }
      ++num;
